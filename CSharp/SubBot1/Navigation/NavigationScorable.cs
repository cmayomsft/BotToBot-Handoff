...
namespace SubBot1.Navigation
{
    ...
    public class NavigationScorable : ScorableBase<IActivity, string, double>
    {
        ...
        public NavigationScorable(IDialogStack stack, IDialogTask task)
        {
            ...
            this.navigationCommands.Add(Resources.SubBot1_Menu);
            this.navigationCommands.Add(Resources.SubBot1_1_Menu);
            this.navigationCommands.Add(Resources.SubBot1_2_Menu);
            this.navigationCommands.Add(Resources.SubBot1_3_Menu);
        }
