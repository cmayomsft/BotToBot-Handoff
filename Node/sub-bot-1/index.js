...
var serverPort = config.port || config.PORT || 3980;
...
bot.dialog('SubBot 1.1 Dialog', dialogBuilder.build('SubBot 1.1 Dialog'));
bot.dialog('SubBot 1.2 Dialog', dialogBuilder.build('SubBot 1.2 Dialog'));
bot.dialog('SubBot 1.3 Dialog', dialogBuilder.build('SubBot 1.3 Dialog'));
...
bot.use({
    botbuilder: (session, next) => {
        ...
        let navCommands = [res.SUB_BOT_1_1_MENU, res.SUB_BOT_1_2_MENU, res.SUB_BOT_1_3_MENU, res.SUB_BOT_1_MENU];
